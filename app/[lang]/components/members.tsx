...
import { Member, members } from '@/config/member';
      ...
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-10 md:grid-cols-2 xl:grid-cols-4">
          {randomMembers.map((member, i) => (
            <div
              className="flex flex-col items-center p-8 transition-colors duration-300 transform border border-slate-400 rounded-xl hover:border-transparent group hover:bg-red-500"
              key={i}
            >
              <div className="overflow-hidden rounded-full ring-4 ring-red-500">
                <Image
                  className="object-cover w-32 h-32  transition-transform duration-300 hover:scale-125"
