...
- Els components estan fets amb react i emotion, a part de tenir un estil propi, també fan servir els tokens de @nike/design-system-base.
- Utilitzen el servei de newrelic per capturar errors i excepcions del client.
- Utilitzen el servei de adobe target per fer proves A/B i multivariants.
- Utilitzen el servei de optimizely per fer proves A/B i multivariants.
