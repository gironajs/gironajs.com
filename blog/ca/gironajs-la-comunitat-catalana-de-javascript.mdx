...
<div className="gjs-aspect-ratio-786-500" style={{outline: '1px solid #d9d9d9', borderRadius: '4px'}}>
    <img src="/assets/blog/gironajs-la-comunitat-catalana-de-javascript/cover-image.jpg" alt="Presentació del projecte GironaJS, la primera comunitat catalana de JavaScript" style={{maxWidth: '100%', margin: 'auto'}}/>
</div>
