...
Girona is an exceptional city to live in with an inspiring environment and a high quality of life.

During the last years, the development sector in Girona has experienced substantial growth due to remote working and the strong commitment by companies in the area to their digitization trying to keep talent here.
...
The channel target audience are JavaScript developers. However, we also have channels to promote communication and networking in other areas. Everything related to job offers is forbidden.

> Don't wait more, [join the Discord](https://discord.gg/eBkQTD2Pax) now!

#### 3. Monthly talks

One of our main goals is to promote networking inside Girona's JavaScript ecosystem.
...
If you want, write a new blog post for your talk, sharing your knowledge and giving you visibility.

If you want to propose a topic, go to [Discord](https://discord.gg/eBkQTD2Pax) and comment in the `#xerrades` channel.
...
We are open to organizing JavaScript related workshops based on community suggestions.
...
At GironaJS, we push for being open source. One example is our website [gironajs.com](https://gironajs.com/). If you have an idea for an open source project that could be carried out by the community, please join our Discord server and share it in the `#open-source` channel.
...
We want to thank everyone who has participated in organizing the community, preparing the talks, writing the blog, etc.
...
However, our meetings, talks, and workshops will mostly take place at an office of one of our sponsors, specifically at [GironaHub](https://girona-hub.com/).
...
> If you are interested in becoming a sponsor, we recommend you join our [Discord server](https://discord.gg/eBkQTD2Pax) and send a message to the `#pregunta-qualsevol-cosa` channel, which is open to everyone.

### Final thoughts

We believe that Girona has great talent and potential that often remains unnoticed. With this conviction, we have created GironaJS aiming to merge this talent, increasing networking, and sharing everyone's knowledge.
