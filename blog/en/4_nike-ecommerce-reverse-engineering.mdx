---
title: Reverse engineering of Nike's browser-only e-commerce
...
seo:
  metatitle: >
    Reverse engineering of Nike's browser-only e-commerce
  metadescription: >
...
Una de las preguntas que me planteabas era si utilizaban GraphQL o si todo se trataba de APIs personalizadas/RESTful. Aunque claramente dominan más las APIs REST, sí emplean GraphQL, específicamente en el manejo de las listas de deseos (wishlists) al recuperar los elementos, por ejemplo.
